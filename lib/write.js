...
class Write {
    ...
    unicode(value, buffer, def, record) {
		if (record.deleted) value = '';
    ...
    value(value, buffer, def, record) {
        ...
        switch (def.type) {
            ...
            case 'bcdbe':
                ...
                break;
            case 'ascii':
                this.ascii(v, buffer, def, record);
                break;
            case 'unicode':
                this.unicode(v, buffer, def, record);
                break;
            case 'bit':
            case 'bitfield':
