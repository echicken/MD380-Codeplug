...
const Map = {
    ...
    uncharted_4 : {
        ...
        records : 1,
        record_length : 122
        // These belong under button_definitions
        // Byte 9017: One Touch Access 1
        // Byte 9021: One Touch Access 2
        // Byte 9025: One Touch Access 3
        // Byte 9029: One Touch Access 4
        // Byte 9033: One Touch Access 5
        // Byte 9037: One Touch Access 6
        // One touch access values would encode:
        // - Mode (None/Digital/Analog) byte 0, bitfield ((1<<5)|(1<<4)) 0 = none, 1 = digital, 2 = analog
        // - Call (key into Contacts) (uint8) byte 2
        // - Call type ((Call/Text if mode digital)/(DTMF[1-4] if mode Analog)) byte 0, bitfield (1<<1)|(1<<0)
        //   - Analog: 0 = DTMF-1, 1 = DTMF-2, 2 = DTMF-3, 3 = DTMF-4
        //   - Digital: 0 = Call, 1 = Text Message
        // - Message/Encode (key into Text Messages or DTMF Signalling - Encode section) (uint8) byte 1
