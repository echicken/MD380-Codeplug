...
const Map = {
    ...
    uncharted_4 : {
        ...
        records : 1,
        record_length : 14
		// Number Key Quick Contact possibly in here, 10 bytes
	...
	quick_contact : {
		...
		record_length : 2,
		data : {
			key_0 : { // keys 1 - 9 will be autocreated later
				type : 'uint16le',
				offset : 0
			}
		}
...
// Map.quick_contact.data[key_1 ... key_9]
add_subfields(Map.quick_contact, 'key_', 2, 9, 'uint16le', 2, validate.contact);
