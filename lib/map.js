...
const Map = {
    ...
    uncharted_4 : {
        ...
        // - Mode (None/Digital/Analog) (bitfield?)
        // - Call (key into Contacts) (uint8?)
        // - Call type ((Call/Text if mode digital)/(DTMF[1-4] if mode Analog)) (bitfield?)
        // - Message/Encode (key into Text Messages) (uint8?)
