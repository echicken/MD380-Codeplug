...
const Map = {
    uncharted_1 : {
        ...
        records : 1,
        record_length : 8805
        // Byte offset 310, unknown
        // Byte offset 313: uint32le BCD frequency range, 48004000 = 400 to 480 MHz, 40003500 = 350 to 400 MHz
        // Byte offset 8742: uint32be BCD last programmed date (day, month, and year)
        // Byte offset 8746: uint32be BCD last programmed date (hours, minutes, seconds)
        // Byte offset 127032, 127036 unknown
    },
    settings : {
        offset : 8805,
        records : 1,
