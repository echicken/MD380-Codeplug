...
const Map = {
    ...
    settings : {
        ...
        data : {
            ...
            group_call_hang_time : {
                type : 'uint8',
                offset : 73,
                validate : (v) => v >= 5 && v <= 70 && v % 5 === 0
            },
            private_call_hang_time : {
                type : 'uint8',
                offset : 74,
                validate : (v) => v >= 5 && v <= 70 && v % 5 === 0
            },
            ...
            scan_digital_hang_time : {
                type : 'uint8',
                offset : 83,
                validate : (v) => v >= 5 && v <= 100
            },
            scan_analog_hang_time : {
                type : 'uint8',
                offset : 84,
                validate : (v) => v >= 5 && v <= 100
            },
    ...
    channels : { // 'Channels Information' section in CPS MD380
        ...
        data : {
            ...
            decode_1 : { // 0 off, 1 on; if 'rx signalling system' not 'off', these are the 'decode' checkboxes in CPS MD380 and relate to the DTMF Signaling section
                type : 'bit',
                offset : 14,
                bit_offset : 0
            },
...
// Map.zones.data[channel_1 ... channel_32]
