...
class Codeplug {
    ...
    constructor (buffer) {
        ...
        this._properties.uncharted_4 = load_uncharted(buffer, Map.uncharted_3);
        ...
        this._properties.uncharted_5 = load_uncharted(buffer, Map.uncharted_4);
        this._properties.channels = load_records(buffer, Map.channels);
        this._properties.uncharted_6 = load_uncharted(buffer, Map.uncharted_5);
