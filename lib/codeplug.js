...
class Codeplug {
    ...
    constructor (buffer) {
        ...
        this._properties.button_definitions = new Record(
            buffer.slice(
                Map.button_definitions.offset,
                Map.button_definitions.offset + Map.button_definitions.record_length
            ),
            Map.button_definitions
        );
        ...
        this._properties.uncharted_7 = load_uncharted(buffer, Map.uncharted_7);
    ...
    serialize() {
        ...
        buffer = Buffer.concat([ buffer, this._properties.button_definitions.serialize() ]);
        ...
        buffer = Buffer.concat([ buffer, this._properties.uncharted_7 ]);
        return buffer;
    }
